...
public class MailRunnableInfo implements Runnable {
...
/*	MailRunnableAttach mailRunnableToTeam = new MailRunnableAttach(resultForm.getMissTestResult().getMsId(),
	...
	public MailRunnableInfo(
			/*,Long mtrId,Long msId,String mailAttachReport,
			String msOrder,String mraLang,S
			*/String rootPath,String protocal_,String  host_,String email_ ,String  password_,String  useAuthen_,
